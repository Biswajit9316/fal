                ...
                >
                    ...
                    <form style={{ width: '80%' }} onSubmit={handleSubmit}>
                        ...
                        <div className={`form-outline mb-4 ${isTextboxClicked ? "clicked" : ""}`} >
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} type="email" id="loginName" className="form-control" style={{ border: '1px solid #949495', minWidth: '0' }} placeholder="Email Address" />
                        ...
                        <div className="row mb-4">
                            ...
                            <div className="col-md-6 d-flex justify-content-center">
                                ...
                                <div className="form-check mb-3 mb-md-0">
                                    ...
                                    <input className="form-check-input" type="checkbox" value="" id="loginCheck" style={{ position: 'relative', right: '35px' }} />

                                    <label className="form-check-label" style={{ fontWeight: 'bold', fontSize: '14px', color: 'black', position: 'relative', right: '35px' }}> Remember me </label>
